...
def geom_gaussian_distance(x, y, epsilon=0.3, p=2):
...
if __name__ == "__main__":
    ...
    distance_type = "energy"  # or "gaussian" or "sinkhorn"
    ...
    #nib.save(nii, "gaussian_sphere.nii")
    #nib.save(nii, "sinkhorn_sphere.nii")
    nib.save(nii, "energy_sphere.nii")
