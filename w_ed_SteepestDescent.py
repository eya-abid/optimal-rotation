...
def run():
    ...
    optimizer = pymanopt.optimizers.SteepestDescent(verbosity=2)
    ...
    create_gif(intermediate_rotations, A, B, filename='intermediate_rotations_SteepestDescent.gif')
...
def create_gif(intermediate_rotations, A, B, filename='intermediate_rotations_SteepestDescent.gif'):
    images = []
